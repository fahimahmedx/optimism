		...
		},
		{
			...
			Batch: BatchWithL1InclusionBlock{
				...
				Batch: &SingularBatch{
					...
					EpochNum:     rollup.Epoch(l2A1.L1Origin.Number),
					EpochHash:    l2A1.L1Origin.Hash,
					Timestamp:    l2A1.Time + timeint.FromUint64SecToMilli(1), // 1 too high
					Transactions: nil,
				},
			},
		...
		},
		{
			...
			Batch: BatchWithL1InclusionBlock{
				...
				Batch: &SingularBatch{
					...
					EpochNum:     rollup.Epoch(l2A1.L1Origin.Number),
					EpochHash:    l2A1.L1Origin.Hash,
					Timestamp:    l2A1.Time - timeint.FromUint64SecToMilli(1), // block time is 2, so this is 1 too low
					Transactions: nil,
				},
			},
			Expected: BatchDrop,
	...
	spanBatchTestCases := []ValidBatchTestCase{
		{
			...
			Batch: BatchWithL1InclusionBlock{
				...
				}, timeint.FromUint64SecToMilli(0), big.NewInt(0)),
			},
			Expected:    BatchUndecided,
				...
				Batch: initializedSpanBatch([]*SingularBatch{
					{
						...
						EpochNum:     rollup.Epoch(l2A1.L1Origin.Number),
						EpochHash:    l2A1.L1Origin.Hash,
						Timestamp:    l2A0.Time + timeint.FromUint64SecToMilli(1),
						Transactions: nil,
					},
					{
						ParentHash:   l2A1.Hash,
						EpochNum:     rollup.Epoch(l2A2.L1Origin.Number),
						EpochHash:    l2A2.L1Origin.Hash,
						Timestamp:    l2A1.Time + timeint.FromUint64SecToMilli(1),
						Transactions: nil,
					},
				}, timeint.FromUint64SecToMilli(0), big.NewInt(0)),
			},
